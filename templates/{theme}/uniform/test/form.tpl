{*
	...
	<span data-uniform="/engine/ajax/uniform/uniform.php" data-uf-settings='{"formConfig": "test", "fields":{"morefield1": "скрытый текст", "morefield2": "Ещё скрытый текст", "notsend": "Это поле не учитывается т.к. не прописано в конфиге"}}' class="uf-btn">Тестовая форма</span>
*}
